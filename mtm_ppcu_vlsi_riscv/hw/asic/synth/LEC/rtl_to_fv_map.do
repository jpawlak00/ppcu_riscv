...
# Generated on: Tue Sep 12 20:27:34 CEST 2023 (Tue Sep 12 18:27:34 GMT 2023)
...
set_log_file ./LEC/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information ./LEC -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/GENUS191/tools"
set CDN_SYNTH_ROOT      "/cad/GENUS191/tools"
set env(CW_DIR) "/cad/GENUS191/tools/lib/chipware"
set CW_DIR      "/cad/GENUS191/tools/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_notranslate_modules -library -both TS1N40LPB4096X32M4M

add_search_path . /cad/GENUS191/tools/lib/tech -library -both
read_library -liberty -both /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tcbn40lpbwp_200a/tcbn40lpbwpwc.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tcbn40lpbwp_200a/tcbn40lpbwplt.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tcbn40lpbwp_200a/tcbn40lpbwpwcl.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tcbn40lpbwp_200a/tcbn40lpbwpml.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tcbn40lpbwp_200a/tcbn40lpbwpwcz.lib /cad/dk/PDK_CRN45GS_DGO_11_25/IMEC_RAM_generator/ram/ts1n40lpb4096x32m4m_250a/NLDM/ts1n40lpb4096x32m4m_250a_ss0p99v125c.lib /cad/dk/PDK_CRN45GS_DGO_11_25/IMEC_RAM_generator/ram/ts1n40lpb4096x32m4m_250a/NLDM/ts1n40lpb4096x32m4m_250a_ff1p21vm40c.lib /cad/dk/PDK_CRN45GS_DGO_11_25/IMEC_RAM_generator/ram/ts1n40lpb4096x32m4m_250a/NLDM/ts1n40lpb4096x32m4m_250a_ss0p99vm40c.lib /cad/dk/PDK_CRN45GS_DGO_11_25/IMEC_RAM_generator/ram/ts1n40lpb4096x32m4m_250a/NLDM/ts1n40lpb4096x32m4m_250a_ff1p21v125c.lib /cad/dk/PDK_CRN45GS_DGO_11_25/IMEC_RAM_generator/ram/ts1n40lpb4096x32m4m_250a/NLDM/ts1n40lpb4096x32m4m_250a_ss0p99v0c.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tpfn40lpgv2od3_120a/tpfn40lpgv2od3wc1.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tpfn40lpgv2od3_120a/tpfn40lpgv2od3lt1.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tpfn40lpgv2od3_120a/tpfn40lpgv2od3wcl1.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tpfn40lpgv2od3_120a/tpfn40lpgv2od3ml1.lib /cad/dk/PDK_CRN45GS_DGO_11_25/digital/Front_End/timing_power_noise/NLDM/tpfn40lpgv2od3_120a/tpfn40lpgv2od3wcz1.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  rtl/netlist.sv
elaborate_design -golden -root {mtm_riscv_chip} -rootonly 

read_design -verilog95   -revised -lastmod -noelab ./LEC/fv_map.v.gz
elaborate_design -revised -root {mtm_riscv_chip}
...
#add_name_alias ./LEC/fv_map.singlebit.original_name.alias.json.gz -revised
